const SITE = (process.env.VITE_STOREFRONT_URL || 'https://www.mushkfragrance.com').replace(/\/$/, '')
const API = (process.env.VITE_API_URL || 'https://mushk-ecommerce-web-app-production.up.railway.app/api').replace(
  /\/$/,
  '',
)
