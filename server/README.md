...
Node.js + Express + MongoDB backend for the Mushk Fragrance ecommerce platform.
...
- Folders: `mushk-fragrance/hero`, `category-him`, `category-her`, `category-unisex`, `product`
